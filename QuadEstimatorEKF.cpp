/*
This is Part of the project 4 (Estimation) of the FCND program
Written by Abuhanif Bhuiyan. Submitted for review on Jul 26, 2018
*/
...
void QuadEstimatorEKF::UpdateFromIMU(V3F accel, V3F gyro)
{
  ...
  // Created a quaternion class object from the Roll, Pitch and Yaw
	...
	// Used the built in function of the quaternon class to integrate using giro and DT of the IMU
	attitude.IntegrateBodyRate(gyro, dtIMU);

	// Get the integrated Roll, Pitch and Yaw to be used on the integraton and update function
...
VectorXf QuadEstimatorEKF::PredictState(VectorXf curState, float dt, V3F accel, V3F gyro)
{
  ...
  // Obtain rotation matrix R_b_g: Mat3x3F R_b_g = attitude.RotationMatrix_IwrtB();
  ...
  B[4] = s_dot_dot.y * dt;
  B[5] = s_dot_dot.z * dt;
  B[6] = 0.0; // To avoids double integration
